...
class NeighborDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_neighbor_details, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment NeighborDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NeighborDetailsFragment().apply {
